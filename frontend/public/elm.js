...
var $author$project$Pages$Exercises$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SelectGame':
				var _v2 = msg.a;
				var fetchCmd = $author$project$Exercises$ChordGuesserExercise$fetchSubExercisesCmd;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentGame: $elm$core$Maybe$Just($author$project$Pages$Exercises$ChordGuesser)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Pages$Exercises$ChordGuesserMsg, fetchCmd));
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Exercises$ChordGuesserExercise$stringFromDifficulty = function (difficulty) {
	switch (difficulty.$) {
		case 'Easy':
			return 'Easy';
		case 'Medium':
			...
			function (difficulty) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Exercises$ChordGuesserExercise$stringFromDifficulty(difficulty))
						]));
			},
			difficulties));
};
...
var $author$project$Exercises$ChordGuesserExercise$viewSubExercise = function (subExercise) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
...
var $author$project$Exercises$ChordGuesserExercise$viewSubExercises = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		return A2(
			$elm$html$Html$ul,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Exercises$ChordGuesserExercise$viewSubExercise, subExercises));
	} else {
		return A2(
			$elm$html$Html$p,
			_List_Nil,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Chosen difficulty: ' + $author$project$Exercises$ChordGuesserExercise$stringFromDifficulty(model.chosenDifficulty))
					])),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick(
											$author$project$Pages$Exercises$SelectGame($author$project$Pages$Exercises$ChordGuesser)),
											$elm$html$Html$Attributes$class('custom-button')
										]),
									_List_fromArray(
										[
