...
var $author$project$Route$ChordGuesserRoute = {$: 'ChordGuesserRoute'};
var $author$project$Route$Dashboard = {$: 'Dashboard'};
var $author$project$Route$Exercises = function (a) {
	return {$: 'Exercises', a: a};
};
var $author$project$Route$ExercisesHome = {$: 'ExercisesHome'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Exercises($author$project$Route$ExercisesHome),
			$elm$url$Url$Parser$s('all-exercises')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Exercises($author$project$Route$ChordGuesserRoute),
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('all-exercises'),
				$elm$url$Url$Parser$s('chord-guesser')))
		]));
...
var $author$project$Db$Auth$UserResponse = function (user) {
	return {user: user};
};
...
var $author$project$Db$Auth$User = F4(
...
var $author$project$Db$Auth$userResponseDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Db$Auth$UserResponse,
	A2(
		$elm$json$Json$Decode$field,
		'user',
		$elm$json$Json$Decode$maybe($author$project$Db$Auth$userDecoder)));
var $author$project$Db$Auth$getMe = function (toMsg) {
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Db$Auth$userResponseDecoder),
			headers: _List_Nil,
			method: 'GET',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Db$Auth$baseUrl + '/users/me'
		});
};
var $author$project$Pages$Dashboard$init = _Utils_Tuple2(
	{user: $elm$core$Maybe$Nothing},
	$author$project$Db$Auth$getMe($author$project$Pages$Dashboard$GotUser));
...
var $author$project$Db$Exercises$CompletedSubExercise = F5(
	function (id, subExerciseId, difficulty, shuffled, chosenKey) {
		return {chosenKey: chosenKey, difficulty: difficulty, id: id, shuffled: shuffled, subExerciseId: subExerciseId};
	});
var $author$project$Db$Exercises$completedExerciseDecoder = A6(
	$elm$json$Json$Decode$map5,
	...
	A2($elm$json$Json$Decode$field, 'chosen_key', $elm$json$Json$Decode$string));
var $author$project$Db$Exercises$completedExercisesDecoder = A2(
	...
	A2(
		$elm$json$Json$Decode$field,
		'completed_exercises',
		$elm$json$Json$Decode$list($author$project$Db$Exercises$completedExerciseDecoder)));
var $author$project$Db$Exercises$fetchCompletedExercises = function (toMsg) {
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Db$Exercises$completedExercisesDecoder),
			headers: _List_Nil,
			method: 'GET',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Exercises$ChordGuesserExercise$GotSubExercises = function (a) {
	return {$: 'GotSubExercises', a: a};
};
...
var $author$project$Db$Exercises$subExerciseDecoder = A5(
	...
	A2(
		...
		'endpoints',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Db$Exercises$fetchSubExercises = F2(
	function (exerciseId, toMsg) {
		return $elm$http$Http$get(
			{
				expect: A2(
					$elm$http$Http$expectJson,
					toMsg,
					$elm$json$Json$Decode$list($author$project$Db$Exercises$subExerciseDecoder)),
				url: $author$project$Db$Exercises$baseUrl + ('/sub-exercises/exercise-id/' + exerciseId)
			});
	});
...
var $author$project$Exercises$ChordGuesserExercise$init = function (_v0) {
	return _Utils_Tuple2(
		{
			allKeys: _List_fromArray(
				['C', 'B#', 'C#', 'Db', 'D', 'D#', 'Eb', 'E', 'Fb', 'E#', 'F', 'F#', 'Gb', 'G', 'G#', 'Ab', 'A', 'A#', 'Bb', 'B', 'Cb']),
			...
			rootNotes: _List_fromArray(
				['C', 'F', 'G']),
			score: 0,
			subExercises: $elm$core$Maybe$Nothing
		},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					$author$project$Exercises$ChordGuesserExercise$fetchSubExercisesCmd
				])));
};
var $author$project$Pages$Exercises$init = function (route) {
	var currentGame = function () {
		if (route.$ === 'ChordGuesserRoute') {
			return $elm$core$Maybe$Just($author$project$Pages$Exercises$ChordGuesser);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	}();
	var _v0 = $author$project$Exercises$ChordGuesserExercise$init(_Utils_Tuple0);
	...
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Platform$Cmd$map, $author$project$Pages$Exercises$ChordGuesserMsg, chordCmd)
				])));
};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var _v1 = function () {
			switch (route.$) {
				case 'Exercises':
					var exercisesRoute = route.a;
					var _v3 = $author$project$Pages$Exercises$init(exercisesRoute);
					var m = _v3.a;
					var c = _v3.b;
					return _Utils_Tuple2(
...
var $author$project$Pages$Exercises$subscriptions = function (model) {
	return A2(
		$elm$core$Platform$Sub$map,
		$author$project$Pages$Exercises$ChordGuesserMsg,
		$author$project$Exercises$ChordGuesserExercise$subscriptions(model.chordGuesserModel));
};
...
var $author$project$Db$Auth$githubClientId = 'Ov23li9EHrE7iB79p8Ph';
...
var $author$project$Db$Auth$googleClientId = '410839726466-e2f6cb7hfk5n3euenjngsia9qdfkjrhn.apps.googleusercontent.com';
...
var $author$project$Db$Auth$logout = function (toMsg) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$emptyBody,
			expect: $elm$http$Http$expectWhatever(toMsg),
			url: $author$project$Db$Auth$baseUrl + '/auth/logout'
		});
};
var $author$project$Main$AuthRefreshed = function (a) {
	return {$: 'AuthRefreshed', a: a};
};
var $author$project$Db$Auth$refreshToken = function (toMsg) {
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: $elm$http$Http$expectWhatever(toMsg),
			...
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Db$Auth$baseUrl + '/auth/refresh'
		});
};
var $author$project$Main$onProtectedCallFail = F2(
	function (retry, model) {
		return model.auth.refreshing ? _Utils_Tuple2(
			_Utils_update(
				model,
				{
					auth: {
						refreshing: false,
						retryAfterRefresh: $elm$core$Maybe$Just(
							_Utils_Tuple2(retry, model.url))
					}
				}),
			...
			$author$project$Db$Auth$refreshToken($author$project$Main$AuthRefreshed));
	});
...
var $author$project$Db$Exercises$buildErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
	...
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		...
		if (_Utils_eq(chosenChord.chord, correctChord.chord)) {
			...
			var updatedModel = function () {
				if (newScore === 10) {
					var cmd = function () {
						var _v1 = _Utils_Tuple2(model.chosenSubExercise, model.chosenKey);
						if ((_v1.a.$ === 'Just') && (_v1.b.$ === 'Just')) {
							var chosenSubExercise = _v1.a.a;
							var chosenKey = _v1.b.a;
							var body = $elm$json$Json$Encode$object(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'chosen_key',
										$elm$json$Json$Encode$string(chosenKey))
									]));
...
var $author$project$Db$TheoryApi$baseUrl = 'https://music-theory-api-tuhh.onrender.com/api/v1';
...
var $author$project$Db$TheoryApi$chordDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Db$TheoryApi$Chord,
...
var $author$project$Db$TheoryApi$fetchChords2 = F3(
	function (key, chordTypes, toMsg) {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Db$TheoryApi$chordsDecoder),
				url: $author$project$Db$TheoryApi$baseUrl + ('/chords/' + (key + ('?' + $author$project$Db$TheoryApi$parseChordTypes(chordTypes))))
			});
	});
...
var $author$project$Exercises$ChordGuesserExercise$pickRandomChord = F2(
	function (maybeChords, randomIndex) {
		if (maybeChords.$ === 'Just') {
			var chords = maybeChords.a;
			var _v1 = A2($elm_community$list_extra$List$Extra$getAt, randomIndex, chords);
			if (_v1.$ === 'Just') {
				var randomChordObject = _v1.a;
				return randomChordObject;
			} else {
				return $author$project$Exercises$ChordGuesserExercise$defaultChord;
			}
		} else {
			return $author$project$Exercises$ChordGuesserExercise$defaultChord;
		}
...
var $author$project$Exercises$ChordGuesserExercise$updateChordList = F3(
	function (model, correctChord, chords) {
		var pool = A2(
		...
		var numberOfChords = function () {
			...
			if (_v0.$ === 'Just') {
				var chordList = _v0.a;
				return $elm$core$List$length(chordList);
			} else {
				return 0;
			}
		}();
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								completedSubExercises: $elm$core$Maybe$Just(response)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
						...
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just(
									$author$project$Db$Exercises$buildErrorMessage(err))
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'KeyChosen':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							chosenKey: $elm$core$Maybe$Just(newKey)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChordGroupChosen':
				var subExercise = msg.a;
				var fetchCount = $elm$core$List$length(model.rootNotes);
				var fetchChordsCmd = function () {
					var _v1 = model.chosenKey;
					if (_v1.$ === 'Just') {
						var chosenKey = _v1.a;
						return A3($author$project$Db$TheoryApi$fetchChords2, chosenKey, subExercise.endpoints, $author$project$Exercises$ChordGuesserExercise$GotChordData);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				}();
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								subExercises: $elm$core$Maybe$Just(result)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
...
var $author$project$Pages$Login$LoginResult = function (a) {
	return {$: 'LoginResult', a: a};
};
var $author$project$Pages$Login$httpErrorToString = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
			var msg = httpError.a;
			return 'Bad url: ' + msg;
...
var $author$project$Db$Auth$loginDecoder = A3(
	...
	A2($elm$json$Json$Decode$field, 'ok', $elm$json$Json$Decode$bool),
	A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$string));
var $author$project$Db$Auth$login = F2(
	function (body, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(body),
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Db$Auth$loginDecoder),
				headers: _List_Nil,
				method: 'POST',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
			...
			case 'Submit':
				if (model.isSubmitting) {
					...
					return _Utils_Tuple2(
						...
						A2($author$project$Db$Auth$login, body, $author$project$Pages$Login$LoginResult));
				}
			default:
				if (msg.a.$ === 'Ok') {
					var response = msg.a.a;
					return response.ok ? _Utils_Tuple2(
						_Utils_update(
							model,
							{error: $elm$core$Maybe$Nothing, isSubmitting: false}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just(response.message),
								isSubmitting: false
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								error: $elm$core$Maybe$Just(
									$author$project$Pages$Login$httpErrorToString(httpError)),
								isSubmitting: false
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Pages$Register$RegisterResult = function (a) {
	return {$: 'RegisterResult', a: a};
};
var $author$project$Pages$Register$httpErrorToString = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
			var msg = httpError.a;
			return 'Bad url: ' + msg;
...
var $author$project$Db$Auth$RegisterResponse = F2(
	function (ok, message) {
		return {message: message, ok: ok};
	});
var $author$project$Db$Auth$registerDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Db$Auth$RegisterResponse,
	A2($elm$json$Json$Decode$field, 'ok', $elm$json$Json$Decode$bool),
	A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$string));
var $author$project$Db$Auth$register = F2(
	function (body, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(body),
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Db$Auth$registerDecoder),
				headers: _List_Nil,
				method: 'POST',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
				url: $author$project$Db$Auth$baseUrl + '/auth/register'
			});
	});
var $author$project$Pages$Register$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SetPassword':
				var p = msg.a;
				var passwordMatch = (!_Utils_eq(model.repeatPassword, p)) ? 'Passwords must match' : '';
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							error: $elm$core$Maybe$Just(passwordMatch),
							password: p
						}),
					$elm$core$Platform$Cmd$none);
			case 'SetRepeatPassword':
				var p = msg.a;
				var passwordMatch = (!_Utils_eq(model.password, p)) ? 'Passwords must match' : '';
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			case 'Submit':
				if (model.isSubmitting) {
					...
					if (!_Utils_eq(model.password, model.repeatPassword)) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									error: $elm$core$Maybe$Just('Passwords must match')
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						var body = $elm$json$Json$Encode$object(
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{error: $elm$core$Maybe$Nothing, isSubmitting: true}),
							A2($author$project$Db$Auth$register, body, $author$project$Pages$Register$RegisterResult));
					}
				}
			default:
				if (msg.a.$ === 'Ok') {
					...
					return response.ok ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Nothing,
								isSubmitting: false,
								successMessage: $elm$core$Maybe$Just(response.message)
							}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								error: $elm$core$Maybe$Just(
									$author$project$Pages$Register$httpErrorToString(httpError)),
								isSubmitting: false
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UrlChanged':
				var newUrl = msg.a;
				var route = $author$project$Route$fromUrl(newUrl);
				var _v1 = function () {
					switch (route.$) {
						case 'Exercises':
							var exercisesRoute = route.a;
			...
			case 'ExercisesMsg':
				var subMsg = msg.a;
				if (subMsg.$ === 'RequestNavigateToChordGuesser') {
					return _Utils_Tuple2(
						model,
						A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/all-exercises/chord-guesser'));
				} else {
					var _v9 = model.page;
					if (_v9.$ === 'ExercisesPage') {
						var m = _v9.a;
						var _v10 = A2($author$project$Pages$Exercises$update, subMsg, m);
						var updated = _v10.a;
						var cmd = _v10.b;
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'RegisterMsg':
				var subMsg = msg.a;
				var _v14 = model.page;
				if (_v14.$ === 'RegisterPage') {
					var m = _v14.a;
					var _v15 = A2($author$project$Pages$Register$update, subMsg, m);
					var updated = _v15.a;
					var cmd = _v15.b;
					if ((subMsg.$ === 'RegisterResult') && (subMsg.a.$ === 'Ok')) {
						var value = subMsg.a.a;
						return value.ok ? _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$RegisterPage(updated)
								}),
							A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/login')) : _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$RegisterPage(updated)
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('footer-social-icons')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('nes-icon facebook is-large')
						]),
					_List_Nil),
					A2(
					$elm$html$Html$i,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('nes-icon instagram is-large')
						]),
					_List_Nil),
					A2(
					$elm$html$Html$i,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('nes-icon linkedin is-large')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('footer-divider')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$ul,
...
var $author$project$Exercises$ChordGuesserExercise$KeyChosen = function (a) {
	return {$: 'KeyChosen', a: a};
};
var $author$project$Exercises$ChordGuesserExercise$viewAllKeys = function (allKeys) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			function (key) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Exercises$ChordGuesserExercise$KeyChosen(key)),
							$elm$html$Html$Attributes$class('nes-btn')
						]),
					_List_fromArray(
						[
...
var $author$project$Exercises$ChordGuesserExercise$viewChooseKey = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$Exercises$ChordGuesserExercise$viewAllKeys(model.allKeys)
			]));
};
...
var $author$project$Exercises$ChordGuesserExercise$checkIfCompleted = F3(
	function (chosenKey, completed, subExercise) {
		return A2(
			$elm$core$List$any,
			function (c) {
				return _Utils_eq(c.subExerciseId, subExercise.id) && _Utils_eq(c.chosenKey, chosenKey);
			},
...
var $author$project$Exercises$ChordGuesserExercise$checkIfCompletedWithShuffle = F3(
	function (chosenKey, completed, subExercise) {
		return A2(
			$elm$core$List$any,
			function (c) {
				return _Utils_eq(c.subExerciseId, subExercise.id) && (_Utils_eq(c.chosenKey, chosenKey) && (c.shuffled === 1));
			},
			completed) ? true : false;
	});
var $author$project$Exercises$ChordGuesserExercise$viewSubExercise = F3(
	function (chosenKey, maybeCompleted, subExercise) {
		var isCompletedWithShuffle = function () {
			if (maybeCompleted.$ === 'Just') {
				var completed = maybeCompleted.a;
				return A3($author$project$Exercises$ChordGuesserExercise$checkIfCompletedWithShuffle, chosenKey, completed.completedSubExercises, subExercise);
			} else {
				return false;
			}
		}();
		var isCompleted = function () {
			if (maybeCompleted.$ === 'Just') {
				var completed = maybeCompleted.a;
				return A3($author$project$Exercises$ChordGuesserExercise$checkIfCompleted, chosenKey, completed.completedSubExercises, subExercise);
			} else {
				return false;
			}
		}();
...
var $author$project$Exercises$ChordGuesserExercise$viewSubExercises = function (model) {
	var _v0 = _Utils_Tuple2(model.subExercises, model.chosenKey);
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var subExercises = _v0.a.a;
		var chosenKey = _v0.b.a;
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Exercises$ChordGuesserExercise$viewSubExercise, chosenKey, model.completedSubExercises),
				subExercises));
	} else {
		return A2(
			$elm$html$Html$p,
...
var $author$project$Exercises$ChordGuesserExercise$viewChooseSubExercises = function (model) {
	return A2(
...
var $author$project$Exercises$ChordGuesserExercise$viewChord = function (chord) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('custom-button'),
				$elm$html$Html$Events$onClick(
				$author$project$Exercises$ChordGuesserExercise$ChordChosen(chord))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(chord.chord)
			]));
};
var $author$project$Exercises$ChordGuesserExercise$viewChords = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		return A2(
			...
			A2($elm$core$List$map, $author$project$Exercises$ChordGuesserExercise$viewChord, chords));
	} else {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
...
var $author$project$Exercises$ChordGuesserExercise$viewGameStarted = function (model) {
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
...
var $author$project$Exercises$ChordGuesserExercise$viewUserWin = function (model) {
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
...
var $author$project$Exercises$ChordGuesserExercise$view = function (model) {
	return model.isGameStarted ? (model.hasUserWon ? $author$project$Exercises$ChordGuesserExercise$viewUserWin(model) : $author$project$Exercises$ChordGuesserExercise$viewGameStarted(model)) : (_Utils_eq(model.chosenKey, $elm$core$Maybe$Nothing) ? $author$project$Exercises$ChordGuesserExercise$viewChooseKey(model) : $author$project$Exercises$ChordGuesserExercise$viewChooseSubExercises(model));
};
var $author$project$Pages$Exercises$view = function (model) {
...
var $author$project$Pages$Register$SetEmail = function (a) {
	return {$: 'SetEmail', a: a};
};
var $author$project$Pages$Register$SetFirstname = function (a) {
	return {$: 'SetFirstname', a: a};
};
var $author$project$Pages$Register$SetLastname = function (a) {
	return {$: 'SetLastname', a: a};
};
var $author$project$Pages$Register$SetPassword = function (a) {
	return {$: 'SetPassword', a: a};
};
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onInput($author$project$Pages$Register$SetEmail)
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onInput($author$project$Pages$Register$SetFirstname)
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$required(true),
									$elm$html$Html$Attributes$type_('text'),
									$elm$html$Html$Attributes$value(model.lastname),
									$elm$html$Html$Events$onInput($author$project$Pages$Register$SetLastname)
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$type_('password'),
									$elm$html$Html$Attributes$value(model.password),
									$elm$html$Html$Events$onInput($author$project$Pages$Register$SetPassword)
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Repeat password')
								])),
							A2(
							$elm$html$Html$input,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$required(true),
									$elm$html$Html$Attributes$type_('password'),
									$elm$html$Html$Attributes$value(model.repeatPassword),
									$elm$html$Html$Events$onInput($author$project$Pages$Register$SetRepeatPassword)
								]),
							_List_Nil)
						])),
					function () {
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							model.isSubmitting ? 'Registering...' : 'Register')
						]))
				]));
	}
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('MUSIC THEORY'),
									A2($elm$html$Html$br, _List_Nil, _List_Nil),
									$elm$html$Html$text('MADE EASY')
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Db.Auth.LoginResponse":{"args":[],"type":"{ ok : Basics.Bool, message : String.String }"},"Db.Auth.RegisterResponse":{"args":[],"type":"{ ok : Basics.Bool, message : String.String }"},"Db.Auth.User":{"args":[],"type":"{ email : Maybe.Maybe String.String, firstname : Maybe.Maybe String.String, lastname : Maybe.Maybe String.String, createdAt : String.String }"},"Db.Auth.UserResponse":{"args":[],"type":"{ user : Maybe.Maybe Db.Auth.User }"},"Db.TheoryApi.Chord":{"args":[],"type":"{ chord : String.String, root : String.String, formula : List.List Basics.Int, degrees : List.List String.String, notes : List.List String.String }"},"Db.Exercises.CompletedResponse":{"args":[],"type":"{ ok : Basics.Bool, message : String.String }"},"Db.Exercises.CompletedSubExercise":{"args":[],"type":"{ id : Basics.Int, subExerciseId : Basics.Int, difficulty : Basics.Int, shuffled : Basics.Int, chosenKey : String.String }"},"Db.Exercises.CompletedSubExercises":{"args":[],"type":"{ completedSubExercises : List.List Db.Exercises.CompletedSubExercise }"},"Db.Exercises.SubExercise":{"args":[],"type":"{ id : Basics.Int, exerciseId : Basics.Int, name : String.String, endpoints : List.List String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"ExercisesMsg":["Pages.Exercises.Msg"],"LoginMsg":["Pages.Login.Msg"],"RegisterMsg":["Pages.Register.Msg"],"DashboardMsg":["Pages.Dashboard.Msg"],"AuthRefreshed":["Result.Result Http.Error ()"],"Logout":[],"LogoutCompleted":[],"ToggleMenu":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Pages.Dashboard.Msg":{"args":[],"tags":{"GotUser":["Result.Result Http.Error Db.Auth.UserResponse"]}},"Pages.Exercises.Msg":{"args":[],"tags":{"ChordGuesserMsg":["Exercises.ChordGuesserExercise.Msg"],"BackToList":[],"RequestNavigateToChordGuesser":[]}},"Pages.Login.Msg":{"args":[],"tags":{"SetUsername":["String.String"],"SetPassword":["String.String"],"Submit":[],"LoginResult":["Result.Result Http.Error Db.Auth.LoginResponse"],"GoogleLogin":[],"GithubLogin":[]}},"Pages.Register.Msg":{"args":[],"tags":{"SetUsername":["String.String"],"SetEmail":["String.String"],"SetFirstname":["String.String"],"SetLastname":["String.String"],"SetPassword":["String.String"],"SetRepeatPassword":["String.String"],"Submit":[],"RegisterResult":["Result.Result Http.Error Db.Auth.RegisterResponse"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Exercises.ChordGuesserExercise.Msg":{"args":[],"tags":{"GotChordData":["Result.Result Http.Error (List.List Db.TheoryApi.Chord)"],"GotSubExercises":["Result.Result Http.Error (List.List Db.Exercises.SubExercise)"],"GotCompletedSubExercises":["Result.Result Http.Error Db.Exercises.CompletedSubExercises"],"CompletedExerciseEntryResponse":["Result.Result Http.Error Db.Exercises.CompletedResponse"],"CorrectChordPicked":["Basics.Int"],"KeyChosen":["String.String"],"ChordChosen":["Db.TheoryApi.Chord"],"ChordGroupChosen":["Db.Exercises.SubExercise"],"ChordNotesShuffled":["List.List String.String"],"ChordsShuffled":["List.List Db.TheoryApi.Chord"],"ToggleNotesShuffle":[],"BackToList":[],"GoBack":[],"ChordListUpdated":["List.List Db.TheoryApi.Chord"]}},"List.List":{"args":["a"],"tags":{}}}}})}});}(this));