...
var $author$project$Exercises$ChordGuesserExercise$viewSubExercises = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		return A2(
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Exercises$ChordGuesserExercise$viewSubExercise, model.chosenKey, model.completedSubExercises),
				subExercises));
	} else {
		return A2(
			$elm$html$Html$p,
